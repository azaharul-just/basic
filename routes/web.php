...
//Profile Update 
Route::get('update/profile/', [ChangePass::class, 'UpdateProfile'])->name('update.profile');
Route::post('update/user/profile/', [ChangePass::class, 'UpdateUserProfile'])->name('update.user.profile');